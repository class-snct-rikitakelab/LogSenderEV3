...
public class BrightnessLogger {
	...
	public static void main(String[] args){
		...
		checkDistanceInit();
		while(true){
			bright = body.getBrightness();
			speed = 25;
			turn = (LTthreshold - bright) * LTmultiplier;
			tail = TAIL_ANGLE_BALANCE;
			runByBalance();
			if(++waittime>5){
				sender.addLog("bright", bright, (System.nanoTime()-starttime)/1000000);
				waittime = 0;
			}
			wait4ms();
			if(checkDistance(1000))break;
		}
		speed = 0;
		turn = 0;
		tail = TAIL_ANGLE_BALANCE;
